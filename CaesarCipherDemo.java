...
public class CaesarCipherDemo
{
    public static void main(String[] args)
    {
         ...
         *  A token in a meaningful sequence of characters (e.g, a word)
         *  Delimiters are characters that seperate tokens
         ...
         *  (i.e, System.in, which is the keyboard via the terminal)
         *  
         */ 
         ...
         *      and returns the value. If the next token cannot be converted, and
